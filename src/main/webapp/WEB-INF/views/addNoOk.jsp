...
<body>
	...
	<div class="alert alert-danger alert-dismissible">
		<a href="${pageContext.request.contextPath}/add" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		<strong>Post o podanym tytule istnieje w bazie!</strong> Spróbuj ponownie!
	</div>
